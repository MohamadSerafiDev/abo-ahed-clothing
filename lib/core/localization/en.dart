const Map<String, String> en = {
  ...
  'confirm_order_msg':
      'Confirm this order? The customer will be notified to upload payment receipt.',
  'verify_payment': 'Verify Payment',
  'reject_payment': 'Reject Payment',
  'reject_payment_msg': 'Reject payment? The order will be cancelled.',
  'confirm_delivery': 'Confirm Delivery',
  'confirm_delivery_msg': 'Confirm delivery of this order?',
  ...
  'admin_orders_failed': 'Failed to load orders',
  ...
  'actions': 'Actions',
  'enter_courier_id': 'Enter courier ID',
